...
import com.document.feed.model.UserAccount;
import com.document.feed.model.UserAccountReactiveRepository;
...
public class JwtAuthenticationHandler {
  ...
  @Autowired private UserAccountReactiveRepository userAccountReactiveRepository;
  ...
  private Mono<ServerResponse> signUp(final ServerRequest request) {
    ...
    final var userMono = request.bodyToMono(UserAccount.class);
